        ...
        <div class="product-wrap">
          <div class="row">
            ...
            <div class="col-right">
              <p>
                <picture>
                  <source srcset="@/assets/img/3_jars/3_jars.webp" type="image/webp" width="350px">
                  <source srcset="@/assets/img/3_jars/3_jars.png" type="image/png" width="350px"> 
                  <img src="@/assets/img/3_jars/3_jars.png" width="350px">
                </picture>
              </p>
              <p>
                <picture>
                  <source srcset="@/assets/img/3_jars/marks.webp" type="image/webp" width="360px">
                  <source srcset="@/assets/img/3_jars/marks.png" type="image/png" width="360px"> 
                  <img src="@/assets/img/3_jars/marks.png" width="360px">
                </picture>
              </p>
            </div>
          </div>
    ...
    <section class="guarantee">
      <div class="container">
        ...
        <ul class="contacts">
          <li>
            <picture>
              <source srcset="@/assets/img/3_jars/icon-phone.webp" type="image/webp">
              <source srcset="@/assets/img/3_jars/icon-phone.png" type="image/png"> 
              <img src="@/assets/img/3_jars/icon-phone.png">
            </picture>
            <a href="tel:8663414691">(866) 341-4691</a>
          </li>
          <li>
            <picture>
              <source srcset="@/assets/img/3_jars/icon-msg.webp" type="image/webp">
              <source srcset="@/assets/img/3_jars/icon-msg.png" type="image/png"> 
              <img src="@/assets/img/3_jars/icon-msg.png">
            </picture>
            <a href="mailto:support@ocmd.co" style="color: #E5805A;">support@ocmd.co</a>
          </li>
        </ul>
        <picture>
          <source class="dr" srcset="@/assets/img/3_jars/dr.webp" type="image/webp">
          <source class="dr" srcset="@/assets/img/3_jars/dr.png" type="image/png"> 
          <img class="dr" src="@/assets/img/3_jars/dr.png">
        </picture>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-left">
            <p>
              <picture>
                <source srcset="@/assets/img/3_jars/3_jarsss.webp" type="image/webp">
                <source srcset="@/assets/img/3_jars/3_jarsss.png" type="image/png"> 
                <img src="@/assets/img/3_jars/3_jarsss.png">
              </picture>
            </p>
            <p>
              <picture>
                <source srcset="@/assets/img/3_jars/marks.webp" type="image/webp">
                <source srcset="@/assets/img/3_jars/marks.png" type="image/png"> 
                <img src="@/assets/img/3_jars/marks.png">
              </picture>
            </p>
          </div>
          <div class="col-right">
