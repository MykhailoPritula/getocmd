<template>
  <div class="form">
    <form v-if="stepOneActive" @submit="stepOne" class="row form-step form-step-one">
      ...
      <div class="field col-12">
        <picture>
          <source srcset="@/assets/img/bank-logos.webp" type="image/webp" width="440px">
          <source srcset="@/assets/img/bank-logos.png" type="image/png" width="440px"> 
          <img src="@/assets/img/bank-logos.png" width="440px">
        </picture>
      </div>
    </form>
    <form @submit="stepTwo" class="row form-step form-step-two" v-else >
      ...
      <div class="col-12">
        ...
        <div class="field-box" id="pp" v-if="product_type == 'onetime'">
          <div class="row">
...
export default {
  ...
  methods: {
    ...
    confirmPP(){
      ...
      const redirectToUpsell = () => this.redirectToUpsell()
